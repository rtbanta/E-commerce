...
<!-- Home_Not_Logged_In_Error.xsl : default home page for application that
			displays error if user is not logged in to application. -->
	...
	<xsl:template match="/">
		<html>
			...
			<body>	
	            ...
	            <h4 id="LoginError"><xsl:value-of select="root/notLoggedInError" /></h4>
			</body>
		</html>
	</xsl:template>
</xsl:stylesheet>