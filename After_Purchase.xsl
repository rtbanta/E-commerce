...
<!-- After_Purchase.xsl : thanks user for purchase and provides same choices
		from account page. -->
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<h4 id="FundsDisplay">Thank you for your purchase!<br />Check your email for details of your purchase.</h4>
