...
<!-- Home_Double_Login_Error.xsl : default home page for application that
			displays error if user tries to login a second time. -->
	...
	<xsl:template match="/">
		<html>
			...
			<body>	
	            ...
	            <h4 id="DoubleLoginError"><xsl:value-of select="root/doubleLoginError" /></h4>
			</body>
		</html>
	</xsl:template>
</xsl:stylesheet>