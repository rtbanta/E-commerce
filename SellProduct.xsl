...
<!-- SellProduct.xsl : allows user to add a product to the application. -->
	...
	<xsl:template match="/">
		<html>
			<head>
                ...
                <link rel="stylesheet" type="text/css" href="CSS/SellProductForm.css" />
			...
			<body>
				...
				<form id="SellForm" action="sell_submit" method="post">
					<br />
					<div id="productType">
