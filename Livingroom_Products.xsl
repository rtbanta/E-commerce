...
<!-- Livingroom_Products.xsl : displays livingroom products from xml file in application. -->
				...
				<form id="BuyForm" action="buy_product" method="post">	
					<table>
						<xsl:for-each select="Products/Product">
							<xsl:if test="@id &lt; 200">
	                			<tr>
	                				<td id="Images" rowspan="4"><img src="{image}" width="80" height="80" /></td>   
	                				<td id="Header"><xsl:value-of select="name" /></td>         	 			
